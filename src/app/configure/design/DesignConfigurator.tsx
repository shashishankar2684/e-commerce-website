...
import HandelComponent from "@/components/HandleComponents";
...
const DesignConfigurator = ({
    ...
    return (
        <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3  mb-20 pb-20">
            <div 
            ref={containerRef}
            className="relative h-[37.5 rem] overflow-hidden col-span-2 w-full max-w-4xl
            flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12
            text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                ...
                resizeHandleComponent={{
                    bottomRight: <HandelComponent/>,
                    bottomLeft:<HandelComponent/>,
                    topLeft: <HandelComponent/>,
                    topRight:<HandelComponent/>,
                }}>
            ...
            <div className="h-[37.5] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
                <ScrollArea className="relative flex-1 overflow-auto">
                    ...
                    <div className="px-8 pb-12 pt-8 ">
                        <h2 className="tacking-tight font-bold text-3xl">
                            Customize your case
                        </h2>
