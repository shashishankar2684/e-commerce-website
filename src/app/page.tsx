      ...
      <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
        <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
         ...
         md:text-6xl text-gray-900">
          ...
          customers<Icons.underline className="hidden sm:block pointer-event-none 
          ...
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
            ...
            <div className=" text-lg leading-8">
              <p>
                ...
                case for two and a half months now and <span className="p-0.5 bg-slate-800 text-white
                ">the image is super clear</span>, on the case I Had
                before, the iamge started fading into yellowish colour after a couple weeks. Love it."
              </p>
            </div>
