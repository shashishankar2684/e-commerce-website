        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            <div className="max-w-xl">
                ...
                <div className="mt-12 text-sm font-medium">
                    <p className="text-zinc-950">Order number</p>
            ...
            <div className="mt-10 border-t border-zinc-200">
                <div className="mt-10 flex flex-auto flex-col">
                    ...
                    <p className="mt-2  text-sm text-zinc-600">
                        We at casecobra beleive that a phone case don't only need to look good, but also last you for 
                        the years to come. We offer a 5-year print gurantee:If your case isn't of the highest quality,
